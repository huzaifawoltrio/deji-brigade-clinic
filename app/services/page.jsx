...
export default function Services() {
  const services = [
    {
      icon: <BrainIcon className="w-20 h-20 text-blue-500" />,
      title: 'Medication Management',
      description: 'Comprehensive psychiatric medication evaluation and ongoing management for optimal mental health outcomes.',
      features: [
    ...
    {
      icon: <MonitorIcon className="w-20 h-20 text-blue-500" />,
      title: 'Telepsychiatry',
      description: 'High-quality psychiatric care from the comfort and convenience of your own space.',
      features: [
    ...
    {
      icon: <ZapIcon className="w-20 h-20 text-blue-500" />,
      title: 'TMS Therapy',
    ...
    {
      icon: <LeafIcon className="w-20 h-20 text-blue-500" />,
      title: 'Collaborative Care',
      description: 'Integrated treatment approach working alongside your existing healthcare team.',
      features: [
      ...
      <section className="pt-32 pb-16 px-6 bg-gradient-to-b from-blue-50 to-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 leading-relaxed">
            Comprehensive psychiatric care tailored to your unique needs and delivered with expertise and compassion.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {[
              ...
              <div
                key={index}
                className="bg-white rounded-lg p-6 border border-gray-200 hover:border-blue-500 transition-all duration-300 shadow"
              >
      ...
      <section className="py-16 px-6 gradient-blue">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-white/90 mb-8 leading-relaxed">
            Take the first step toward better mental health with our expert team.
          </p>
          <Link
            href="/contact"
